...
nome = "Luiza"      # str  — texto sempre entre aspas (duplas ou simples)
idade = 25          # int  — número inteiro
estado = "Pernambuco" # # str  — texto sempre entre aspas (duplas ou simples)
...
idade = "Luiza Vieira" # "Luiza Vieira"
print(idade)
